				...
				<div className="row align-items-center">
					...
					<div className="col-lg-8 col-md-7 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.4s">
						<div className="section-head style-1 text-white">
							...
							<h2 className="title m-b15">Inscrivez-vous à notre Newsletter pour obtenir les dernières nouvelles de BigNova</h2>
							...
							<form className="dzSubscribe" action="script/mailchamp.php" method="post">
								...
								<div className="form-group">
									<div className="input-group">
										<input name="dzEmail" required="required" type="email" className="form-control" placeholder="Adresse e-mail"/>
										<div className="input-group-addon">
											<button name="submit" value="Submit" type="submit" className="btn rounded-xl shadow btn-primary">S'insrire</button>
										</div>
									</div>
								</div>
							</form>
